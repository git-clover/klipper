...
The katapult directory contains code from:
  https://github.com/Arksine/katapult
revision b0bf421069e2aab810db43d6e15f38817d981451.  The Python module,
flashtool.py, is taken from the repo's scripts directory.  It may be
used to upload firmware to devices flashed with the Katapult bootloader.
